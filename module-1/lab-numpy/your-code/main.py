...
'''
no, you can att this two arrays because even they have the same size,
the internal structure of the arrays is different'''
...
print(a == e)
'''
a == e because any number multiplied by one is the same number
'''
